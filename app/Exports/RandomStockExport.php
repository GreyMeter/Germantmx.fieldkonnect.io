...
use App\Models\{RandomStock, CustomerOutstanting, ParentDetail, TransactionHistory, Redemption, MobileUserLoginDetails};
...
class RandomStockExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping, WithEvents
{
    ...
    public function map($data): array
    {
        ...
        return [
            ...
            $data->random_cut ? $data->random_cut : '-',
