...
class AjaxController extends Controller
{
    ...
    public function getConsigneeSuggestions(Request $request)
    {
        $term = $request->input('term');

        $results = ConsigneeDetail::where('consignee_detail', 'LIKE', "%$term%")
            ->pluck('consignee_detail');
