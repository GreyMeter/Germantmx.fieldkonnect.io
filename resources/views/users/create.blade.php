                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="row">
                              ...
                              <div class="col-md-8">
                                 <div class="form-group has-default bmd-form-group">
                                    <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="password" name="password" id="password" value="{{ $user->password_string, old('password') }}" minlength="6" maxlength="200" required>
